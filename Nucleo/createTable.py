...
class CreateTable:
    """
    Contiene la logíca para crear una tabla ASCII, el usuario no tendria que modificar codigo, excepto
    que desee mejorarlo.
    """
    ...
    def initDicHighs(self):
        """
        Se inicializa el diccionario dicHighs en 0.
        :return: booleano
        """
    ...
    def getStrHighs(self):
        """
        Obtiene el tamaño de las cadenas mas grande en cada columna y lo almacena en un diccionario
        (self.__dicHighs)
        :return: booleano
        """
        self.initDicHighs()
    ...
    def getBodyArray(self):
        """
        Obtiene el cuerpo de la tabla, con sus espaciados correspondientes y los almacena en una lista.
    ...
    def getHeaderArray(self):
        """
        Obtiene el encabezado o título de la tabla.
    ...
    def getFooterArray(self):
        """
        Obtiene el footer o pie de la tabla.
    ...
    def formattedElement(self, item, colIndex):
        """
        Se le da formato a la tabla con sus respectivos elementos.
    ...
    def createTable(self):
        """
        Crea la tabla, es la unica función que el usuario deberia de llamar.
